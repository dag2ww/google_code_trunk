/*
   ...
   Program with following settings (status line / IDE):
    ...
    Changes
      ...
      packages/esp8266/hardware/esp8266/2.5.0/cores/esp8266/Esp.h
...
#define DEBUG             // DEBUG or DEBUG_OFF - in debug mode there is no LED on the ESP-01!
