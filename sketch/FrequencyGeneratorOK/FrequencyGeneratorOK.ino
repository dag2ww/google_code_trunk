...
void setup() {
  ...
  //Serial.println();
  FrequencyTimer2::setPeriod(46);//35-60 = 28571.4 - 16666.7
...
void loop() {
  ...
  if(currentTime - lastTime > 700 || currentTime - lastTime < 0){
    if(lastPeriod > 60 || lastPeriod < 35){
      diff = diff * -1;
    }
    lastPeriod = lastPeriod + diff;
    lastTime = currentTime;
    FrequencyTimer2::setPeriod(lastPeriod);
  }
